<div class="container py-5">
    <h2 class="text-primary mb-4"><i class="bi bi-journal-richtext me-2"></i> Documentação do Módulo de Blog</h2>
...
&lt;/script&gt;
    ...
    <hr class="mt-5">
    <p class="text-end text-muted small">Última atualização: <?= date('d/m/Y') ?> • Desenvolvido com 🧠 por Jake.</p>
</div>
